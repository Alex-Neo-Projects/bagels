...
async function main() {
    ...
    let ganachePort = "";
    if (workerData && workerData["ganachePort"]) {
        ganachePort = workerData["ganachePort"];
    }

    const nodeProcess = spawn("node", ["startServer.js", serverToLookIn, networkUrl, ganachePort], {
        cwd: serverDir,
    });
