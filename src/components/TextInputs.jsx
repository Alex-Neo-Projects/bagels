  ...
  return (
    ...
    >
      <div className="flex justify-end w-full items-center space-x-2">
        ...
        {val.stateMutability === 'payable' ? (
          <PayableButton setAmount={setAmount} amount={amount} val={val} buttonClicked={buttonClicked} executingTransaction={executingTransaction} />
        ) : (
